            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Cuerpo') }}</label>

                            <div class="col-md-6">
                                <input id="body" type="text" class="form-control @error('name') is-invalid @enderror" name="body" value="{{ old('body') }}" required autocomplete="body">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Codigo del centro') }}</label>
